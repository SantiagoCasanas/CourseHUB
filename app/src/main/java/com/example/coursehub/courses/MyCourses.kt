...
fun myCourses(navController: NavController,
    ...
    val courses = remember { runBlocking { auth.retrieveCoursesCreatedByMe() } }
    ...
    Box(
        ...
        Column(
            ...
            Box(
                ...
                scrollableListCourses(courses,topics,navController)
            }
        }
    }
...
@Composable
fun courseRow(courseId:String,title:String, author:String, topic:String, topics:List<TopicData>?,navController: NavController){
    ...
    Row(
        modifier = Modifier
            ...
            .clickable {
                ...
                val routeWithParam = "${Screens.CourseContent.name}/$courseId"
...
@Composable
fun scrollableListCourses(itemsList: List<CourseData>?, topics:List<TopicData>?, navController: NavController) {
    LazyColumn {
        items(itemsList!!) { item ->
            courseRow(item.id,item.tittle,item.authorUsername,item.topic, topics!!,navController)
        }
    }
}